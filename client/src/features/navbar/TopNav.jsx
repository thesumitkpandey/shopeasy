  ...
  return (
    <div className="flex justify-between items-center md:px-16 px-2 h-16">
      <TiThMenuOutline
        ...
        className="md:hidden text-4xl text-[rgb(25,186,146)] cursor-pointer transition-transform duration-200 ease-in-out hover:scale-125 hover:text-[rgb(19,145,113)] active:scale-100 active:text-[rgb(16,124,97)]"
      />
      <img
        src={logo}
      ...
      <form className="flex items-center w-full max-w-lg mx-4 border-2 border-transparent bg-[rgb(25,186,146)] rounded-lg overflow-hidden transition duration-200 ease-in-out hover:scale-105 h-10">
        <input
          type="text"
          placeholder="Search anything on ShopEasy"
