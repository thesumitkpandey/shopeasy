...
export default function SignIn() {
  ...
  const roles = [
    {
      type: "User",
      icon: <FaUser className="text-blue-500 text-4xl" />, // Increased size
    },
    {
      type: "Seller",
      icon: <FaStore className="text-green-500 text-4xl" />, // Increased size
    },
    {
      type: "Admin",
      icon: <FaUserShield className="text-red-500 text-4xl" />, // Increased size
    },
  ];
  useEffect(() => {});
